...
installChaincode () {
	PEER=$1
	setGlobals $PEER
        #peer chaincode install -n mycc -v 1.0 /opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02/chaincode_example02.go >&log.txt
	#peer chaincode install -n mycc -v 1.0 -p github.com/hyperledger/fabric/examples/chaincode/go/chaincode_example02 >&log.txt
	peer chaincode install -n mycc -v 1.0 -p github.com/hyperledger/fabric/examples/chaincode/go/newchaincode >&log.txt
        res=$?
	cat log.txt
